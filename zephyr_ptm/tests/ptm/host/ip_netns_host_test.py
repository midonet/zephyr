...
class IPNetNSHostTest(unittest.TestCase):
    def test_configure(self):
        ...
        h.configure_logging(log_file_name="test-ptm.log", debug=True)
    ...
    def test_veth_connection_between_two_hosts(self):
        ...
        h1.configure_logging(log_file_name="test-ptm.log", debug=True)
        h2.configure_logging(log_file_name="test-ptm.log", debug=True)
