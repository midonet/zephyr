...
class TestCaseTest(unittest.TestCase):
    def test_test_case_scenarios(self):
        tc = SampleTestCase()
        self.assertEqual('SampleTestCase', tc.get_name())
    ...
    def test_required_topology_feature(self):
        ...
        test_list = (
            [SampleTopoFeatureTestCase(
                'test_topology_feature_present'),
                SampleTopoFeatureTestCase(
                    'test_topology_feature_with_bool_value'),
                SampleTopoFeatureTestCase(
                    'test_topology_feature_with_int_value'),
                SampleTopoFeatureTestCase(
                    'test_topology_feature_with_func_bool'),
                SampleTopoFeatureTestCase(
                    'test_topology_feature_with_func_int'),
                SampleTopoFeatureTestCase(
                    'test_topology_feature_not_present'),
                SampleTopoFeatureTestCase(
                    'test_topology_feature_not_equal_bool'),
                SampleTopoFeatureTestCase(
                    'test_topology_feature_not_equal_int'),
                SampleTopoFeatureTestCase(
                    'test_topology_feature_func_fails_bool'),
                SampleTopoFeatureTestCase(
